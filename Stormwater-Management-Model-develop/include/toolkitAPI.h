...
typedef enum {
    ...
    SM_SEEPRATE   = 7,
    SM_CONROUGHNESS = 8  // manning's roughness coefficient of conduits. Xichao Gao
} SM_LinkProperty;
...
typedef enum {
    ...
    // add three infiltration parameters.  Xichao Gao.
    SM_SUCT       = 5, // capillary suction SM_SUCTION has been used.
    SM_CONDUCT    = 6,
    SM_IMD        = 7,
    SM_RAINMULTI  = 8,
    SM_PERV_N     = 9,
...
typedef enum {
    ...
    // add roughness coefficient blow. Xichao Gao
} SM_LinkResult;
