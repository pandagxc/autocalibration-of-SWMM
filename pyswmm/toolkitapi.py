...
class SubcParams(Enum):
    ...
    slope = 3  # double
    curbLength = 4  # double
    S = 5 # double  suction presure
    Ks = 6 # double  Sat. hyd. conductivity
    IMD = 7 #double   soil moisture deficit
    rainMulti = 8 # double
    perv_n = 9  # manning coefficient of pervious areas
    imperv_n = 10  # manning coefficient of impervious areas
    perv_sto = 11  # water storage before runoff in pervious areas
    imperv_sto = 12  # in impervious areas
