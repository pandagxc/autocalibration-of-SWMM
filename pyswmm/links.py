...
class Link(object):
    ...
    # add roughness parameter to link object. Xichao Gao
    @property
    def con_roughness(self):
        return self._model.getLinkParam(self._linkid,
                                        LinkParams.cRoughness.value)

    @con_roughness.setter
    def con_roughness(self, param):
        """Set Link Average Seepage Loss."""
        self._model.setLinkParam(self._linkid, LinkParams.cRoughness.value,
                                 param)
