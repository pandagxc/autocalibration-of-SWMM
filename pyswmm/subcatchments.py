...
class Subcatchment(object):
    ...
    # added three subcatchment infiltration parameters. Xichao Gao.
    @property
    def S(self):
    ...
    def Ks(self, param):
        """Set Subcatchment suction."""
        self._model.setSubcatchParam(self._subcatchmentid,
                                     SubcParams.Ks.value, param)
    @property
    def IMD(self):
        return self._model.getSubcatchParam(self._subcatchmentid,
                                            SubcParams.IMD.value)
    @IMD.setter
    def IMD(self, param):
        """Set Subcatchment suction."""
        self._model.setSubcatchParam(self._subcatchmentid,
                                     SubcParams.IMD.value, param)
    @property
    def rainMulti(self):
        return self._model.getSubcatchParam(self._subcatchmentid,
                                            SubcParams.rainMulti.value)
    @rainMulti.setter
    def rainMulti(self, param):
        """Set Subcatchment suction."""
        self._model.setSubcatchParam(self._subcatchmentid,
                                     SubcParams.rainMulti.value, param)
    @property
    def perv_n(self):
        return self._model.getSubcatchParam(self._subcatchmentid,
                                            SubcParams.perv_n.value)
    @perv_n.setter
    def perv_n(self, param):
        self._model.setSubcatchParam(self._subcatchmentid,
                                     SubcParams.perv_n.value, param)
    @property
    def imperv_n(self):
        return self._model.getSubcatchParam(self._subcatchmentid,
                                            SubcParams.imperv_n.value)
    @imperv_n.setter
    def imperv_n(self, param):
        self._model.setSubcatchParam(self._subcatchmentid,
                                     SubcParams.imperv_n.value, param)
    @property
    def perv_sto(self):
        return self._model.getSubcatchParam(self._subcatchmentid,
                                            SubcParams.perv_sto.value)
    @perv_sto.setter
    def perv_sto(self, param):
        self._model.setSubcatchParam(self._subcatchmentid,
                                     SubcParams.perv_sto.value, param)
    @property
    def imperv_sto(self):
        return self._model.getSubcatchParam(self._subcatchmentid,
                                            SubcParams.imperv_sto.value)
    @imperv_sto.setter
    def imperv_sto(self, param):
        self._model.setSubcatchParam(self._subcatchmentid,
                                     SubcParams.imperv_sto.value, param)
    @property
    def width(self):
        """
